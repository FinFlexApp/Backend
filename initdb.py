...
chapters_data = [
    {'sequence': 1, 'name': 'Путешествие в Мир Денег',
     'description': 'Добро пожаловать в увлекательное путешествие в Мир Денег! Здесь мы узнаем, как правильно обращаться с деньгами, чтобы они всегда были на твоей стороне. Готовы к приключению?',
     'source_url': 'https://kartinkis.cdnbro.com/posts/48828606-finansovaia-gramotnost-art-1.jpg'},
    {'sequence': 2, 'name': 'Сокровища Финансовой Мудрости',
     'description': 'Добро пожаловать в Сокровища Финансовой Мудрости! Здесь мы раскроем секреты того, как делать правильные решения с деньгами и сделаем тебя настоящим экспертом в финансах.',
     'source_url': 'https://www.tartaria.ru/Tartaria/ContentAttachments/401913/5289d911-76cb-461b-a412-aaf3746f5e43.jpg'},
    {'sequence': 3, 'name': 'Волшебные Ключи Финансового Успеха',
     'description': 'Добро пожаловать в мир Волшебных Ключей Финансового Успеха! Здесь мы научимся использовать магию денег, чтобы добиться всех своих желаний и мечтаний.',
    ...
    {'sequence': 4, 'name': 'Приключения Денежного Мастера',
     'description': 'Добро пожаловать в увлекательные Приключения Денежного Мастера! Здесь мы станем настоящими экспертами в управлении деньгами и научимся применять наши навыки в реальной жизни.',
    ...
    {'sequence': 5, 'name': 'Финансовые Приключения',
     'description': 'Добро пожаловать в захватывающие Финансовые Приключения! В этой главе мы отправимся в увлекательное путешествие по миру денег и научимся преодолевать финансовые препятствия.',
...
Представитель Google заявил изданию, что компания «инвестирует в самые приоритетные направления» и «вносит изменения,
 чтобы стать эффективнее и лучше работать, сократить бюрократию и многоуровневость». В компании также добавили, что увольнения стали частью реорганизации, а затронутые сотрудники смогут подать заявку на другие открытые вакансии в Google.""",
     "date": datetime.now()},
